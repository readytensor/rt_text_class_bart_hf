...
def load_hf_dataset(
    ...
    Returns:
    - Tuple[Dataset, BertTokenizer]: A tuple containing the tokenized dataset and the tokenizer.
    """
    ...
    tokenizer_path = tokenizer_dir_path if tokenizer_dir_path else "facebook/bart-base"
